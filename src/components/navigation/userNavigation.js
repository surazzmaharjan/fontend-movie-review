    ...
    render() {
        return (
            <div> 
                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-light border-bottom border-bottom-nav-top justify-content-between">
                   ...
                   <img src={process.env.PUBLIC_URL + '/moviereview_logo.png'} height="60" width="70" alt="Movie Review Logo" /> 
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <NavLink  className="dropdown-item" to="/viewallcomments">View Comment List</NavLink>
                            </div>
                        </li>
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        <NavLink className="dropdown-item" to={"/edit/profile/"+this.state.user._id}>
                            My Profile  </NavLink> 
                        <div className="dropdown-divider"></div>
                        <NavLink  className="dropdown-item" to="/viewallwishlist">  My Favourite 
                        </NavLink>
